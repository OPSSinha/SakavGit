<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderMasterAdmin.aspx.cs" Inherits="BachatBazaar.OrderMasterAdmin" %>
  ...
  <div class="content-wrapper" style="margin-top:0px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">&nbsp&nbsp Order Master</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                        ...
                        <Columns>
                           ...
                           --%>
                              <asp:TemplateField HeaderText="Id#">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblItemId" CommandName = "Show"  CommandArgument ='<%# Eval("Sno") %>' Width="80px" Text='<%# Eval("Sno") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                             ...
                             <asp:TemplateField HeaderText="Email Id">
                               ...
                               <asp:TemplateField HeaderText="City">
                                   ...
                                   <asp:TemplateField HeaderText="Mobile No">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMobile"  Text='<%# Eval("MobileNo") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
