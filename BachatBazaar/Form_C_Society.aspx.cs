...
namespace BachatBazaar
{
    ...
    //}
        ...
        {
            DataTable dt = MDC.getDataTable("select max(PK_APP_ID) from Individual_App1");
        ...
        protected void btnSubmit_Click1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //{
                //    MessageBox.Show("Please Enter Category's Name!");
                //    return;
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    dr["Firm"] = txtNames.Text; //  nvarchar(20t0)   Unchecked
