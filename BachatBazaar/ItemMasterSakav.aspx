<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemMasterSakav.aspx.cs" Inherits="BachatBazaar.ItemMasterSakav" %>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
             <!-- <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="ItemMasterSakav.aspx" class="auto-style1">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Item Master</p>
                </a>
              </li>
           ...
           <tr>
              ...
              <table width="100%" >
                ...
                <tr style ="background-color:cornflowerblue ">
                    ...
                    <td>
                        <asp:DropDownList ID="drpCategorySearch" runat ="server" OnSelectedIndexChanged="drpCategorySearch_SelectedIndexChanged" AutoPostBack="true"  >
        ...
        <tr>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox class="form-control" ID="txtDealerId" runat ="server" Enabled="false" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                  ...
                  <%--         <asp:TemplateField HeaderText="Front Single">
                    ...
                    <asp:TemplateField HeaderText="Pos.">
                            ...
                            <asp:TemplateField HeaderText="User">
                                        <ItemTemplate>
                                            <asp:Label  Width="50px" ID="txtLabel" Text  ='<%# Eval("UserName") %>'  runat="server"></asp:Label>
                                        </ItemTemplate>
                           </asp:TemplateField>
