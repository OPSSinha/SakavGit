...
<asp:Content ID ="contents" ContentPlaceHolderID ="ContentPlaceHolder1" runat ="server">
   ...
   <%--Anji--%>
	...
	<div class="gallery py-5 " style="background-color:lightblue; ">
         ...
         <table  style ="border-color: #dfc222;width:auto; vertical-align :middle; padding:0px; border-style: solid;" align="center" >
              ...
              <tr>
                 ...
                 <td>
                     <div class="form-group">
                       <div class="col-md-12">
                            <div class="row">
                                    <asp:Label  ID="lblUserName" runat="server" width="10" Text="UserName" CssClass="col-md-4"></asp:Label>
                                <div class="col-md-8">
             ...
             <tr>
                 ...
                 <td>
                     <div class="form-group">
                       <div class="col-md-12">
                            <div class="row">
                                <asp:Label ID="lblPassword" runat="server" Text="Password" CssClass="col-md-4"></asp:Label>
                                <div class="col-md-8">
                ...
                <tr>
                 <td>
                       ...
                       <div class="col-md-12">
                            <div class="row">
                                <asp:Label ID="lblLoginType" runat="server" Text="Login Type" CssClass="col-md-4"></asp:Label>
                                 <div class="col-md-8">
                                 <asp:DropDownList ID="drpLoginType" runat ="server" class="form-control">
