                                    ...
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <%--<a href="Single.aspx?Id=<%= Session["Id"].ToString()  %>" class="link-product-add-cart">Have a Look</a>--%>
                                               ...
                                               <a href="Product.aspx?txt=<%= strTop1Category   %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    ...
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%= strTop2Category  %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
                            ...
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    ...
                                    <%=LoadTop3() %>
                                        ...
                                        <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%= strTop3Category  %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    ...
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%= strMiddle1Category  %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
...
<!--                                    <img src="images/mk5.jpg" alt="">-->
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%= strMiddle2Category   %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    ...
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%= strMiddle3Category %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
...
<!--                                    <img src="images/mk7.jpg" alt="">-->
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%=  strBottom1Category   %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
...
<!--                                    <img src="images/mk8.jpg" alt="">-->
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%= strBottom2Category  %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
...
<!--                                    <img src="images/mk9.jpg" alt="">-->
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="Product.aspx?txt=<%= strBottom3Category  %>&user=<%= strUsers   %>" class="link-product-add-cart">Have a Look</a>
                                        </div>
                                    </div>
