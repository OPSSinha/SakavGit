...
<form id="form1" runat="server">
 ...
 <%--   <table width="230%" style="background-color:white">
          ...
          <td >
                    ...
                    <td>
                        <asp:DropDownList ID="drpCategorySearch1" runat ="server" OnSelectedIndexChanged="drpCategorySearch1_SelectedIndexChanged"  AutoPostBack="true"  >
                        </asp:DropDownList>
                    </td>
                   <td>
                       Sub-Category
                    ...
                    <td>
                         <asp:DropDownList ID="drpSubCategorySearch1" runat ="server" >
 ...
 <asp:DropDownList ID="drpItemName" runat ="server" OnSelectedIndexChanged="drpItemName_SelectedIndexChanged"></asp:DropDownList>
    ...
    <p>1. Images of Category will be entered for first page. SECTION - A</p>
    <p>2. For each category, images will be entered for second page.</p>
    <p></p>
    <table>
        <tr>
            <td colspan="2">
               <b>SECTION A - "FIRST PAGE - FRONT PAGE IMAGES FOR CATEGORY"</b>
            </td>
        </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                       <asp:DropDownList ID="drpCategory" runat ="server"  Enabled ="false"  Width ="350px">
                       </asp:DropDownList>
                    </td>
                </tr>
                 <tr>
    ...
    <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txtTaxRate" runat ="server" Visible="false" ></asp:TextBox>
                    </td>
                </tr>
    <tr>
                    <td>
                    ...
                    <td>
                      <asp:TextBox ID="txtGst" runat ="server" Visible="false"></asp:TextBox>
                    </td>
                </tr>
    <tr>
                    <td>
                    ...
                    <td>
                      <asp:TextBox ID="txtHSNo" runat ="server" Visible="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIsCOD" runat ="server" Visible ="false" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIsFreeDelivery" runat ="server" Visible ="false" />
                    </td>
                </tr>
               
                <tr>
                    <td>
                       <%-- Is Front Page Top 3 Image?--%>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkIsFrontTop" runat ="server"  Visible ="false"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIsFrontMiddle" runat ="server"  Visible ="false"/>
                    </td>
                </tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIsFrontBottom3" runat ="server"  Visible ="false" />
                    </td>
                </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIsFrontSingle" runat ="server" Visible="false" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIsFrontPageSlider" runat ="server"  Visible ="false" />
                    </td>
                </tr>
             <tr>
                    <td>
                    ...
                    <td>
                        <asp:CheckBox ID="chkIsFrontLeftVerticle" runat ="server"  Visible ="false" />
                    </td>
                </tr>
             <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtFrontPosition" runat ="server"  Visible ="false"  />
                    </td>
                </tr>
            
                <tr>
                    <td colspan ="2">
                        <b>SECTION - B SECOND PAGE - CATEGORY WISE PRODUCT </b>&nbsp;</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <%-- <asp:RadioButton ID="chkIsTop3" runat ="server" GroupName ="ms" Checked="true"  />--%>
                    </td>
                </tr>
             <tr>
                    <td>
                    ...
                    <td>
                       ...
                       <%-- <asp:RadioButton ID="chkIsSliderImage" runat="server"  GroupName ="ms" />--%>
                     </td>
                </tr>
              <tr>
                    <td>
                    ...
                    <td>
                       ...
                       <%--   <asp:RadioButton ID="chkIsLeftSideVerticle" runat="server"  GroupName ="ms" />--%>
                    </td>
                </tr>
             <tr>
                    <td>
