<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyOrder.aspx.cs" Inherits="BachatBazaar.MyOrder" %>
  ...
  <div class="content-wrapper" style="margin-top:0px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">&nbsp&nbsp My Orders</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="MyOrder.aspx">My Orders</a></li>
...
<form id="form1" runat="server">
       <%-- <div align="center" style="background-color:white;width:100%" >--%>
         <asp:Panel ID="pnl1" runat ="server" ScrollBars="Both">
             <table style="width : 40%">
                <tr>
                  <td>
                      <br />
                       <asp:GridView ID="gvMenuTiming"  runat="server" AutoGenerateColumns="False" CssClass="myTableClass" Width="200px" OnRowCommand="gvMenuTiming_RowCommand">
          ...
          --%>           <%--   <Columns>
                        ...
                        <Columns>
                           <%-- <asp:BoundField HeaderText="ID" DataField="PK_APP_ID" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden" />
                            <asp:BoundField HeaderText="ID" DataField="PK_APP_ID" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden" />
                           --%>
                              <asp:TemplateField HeaderText="Id#" HeaderStyle-VerticalAlign="Top">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblItemId" CommandName = "Show"  CommandArgument ='<%# Eval("Sno") %>' Width="40px" Text='<%# Eval("Sno") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Customer Name" HeaderStyle-VerticalAlign="Top">
                                        <ItemTemplate>
                                            <asp:Label ID="lblFullName"  Text='<%# Eval("FullName") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                 <%-- <asp:TemplateField HeaderText="Land Mark" HeaderStyle-VerticalAlign="Top">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLandMark"  Text='<%# Eval("LandMark") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                               <asp:TemplateField HeaderText="City" HeaderStyle-VerticalAlign="Top">
                                        <ItemTemplate>
                                   ...
                                   <asp:TemplateField HeaderText="Mobile No" HeaderStyle-VerticalAlign="Top">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQuanitiy"  Text='<%# Eval("MobileNo") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                            </Columns>
                    </asp:GridView>
