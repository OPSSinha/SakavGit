<%@ Page Language="C#"   AutoEventWireup="true" CodeBehind="~/OrderMaster.aspx.cs" Inherits="BachatBazaar.OrderMaster" %>
          ...
          --%>           <%--   <Columns>
                        ...
                        <Columns>
                           <asp:TemplateField HeaderText="Id">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="txtSno" CommandName = "Show"  CommandArgument ='<%# Eval("Sno") %>' Width="80px" Text='<%# Eval("Sno") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>                          
                              ...
                              <asp:TemplateField HeaderText="FullName">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="txtFullName" CommandName = "Show"  CommandArgument ='<%# Eval("FullName") %>' Width="80px" Text='<%# Eval("FullName") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                              <asp:TemplateField HeaderText="MobileNo">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="txtMobileNo" CommandName = "Show"  CommandArgument ='<%# Eval("MobileNo") %>' Width="80px" Text='<%# Eval("MobileNo") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            <asp:TemplateField HeaderText="LandMark#">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="txtLandMark" CommandName = "Show"  CommandArgument ='<%# Eval("LandMark") %>' Width="80px" Text='<%# Eval("LandMark") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            <asp:TemplateField HeaderText="City">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="txtCity" CommandName = "Show"  CommandArgument ='<%# Eval("City") %>' Width="80px" Text='<%# Eval("City") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            <asp:TemplateField HeaderText="AddressType">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="txtAddressType" CommandName = "Show"  CommandArgument ='<%# Eval("AddressType") %>' Width="80px" Text='<%# Eval("AddressType") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Disp. Date">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDispatchDate"  Text='<%# Eval("DispatchDate") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Delivery By">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDeliveryBy"  Text='<%# Eval("DispatchBy") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
