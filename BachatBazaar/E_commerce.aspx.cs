...
namespace BachatBazaar
{
    public partial class E_commerce : System.Web.UI.Page
    {
        ...
        protected void  GetFirmDetail()
        {
            ...
            strUsers= Request.QueryString["user"].ToString();
            if (strUser == "a")
            {
                SakavFirm = "SAKAV";
        ...
        public string SetFrontImage()
        {
            string htmStr = "";
           string strUser = Request.QueryString["user"].ToString();
            DataTable dt = MDC.getDataTable("Select * from FrontImage where UserName='"+strUser+"' and IsActive=1 order by Sno desc");
            if (dt.Rows.Count > 0)
            {
                //if (dt.Rows[0]["ImageName"] != System.DBNull.Value || dt.Rows[0]["ImageName"].ToString() !="")
                //{
                //    htmStr += "<img src='neuroimg/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='400' width='100%'>";
                //}
            }
            return htmStr;
        }
...

        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                htmlStr += "<Li>";
                htmlStr += "<a href='Product.aspx?txt=" + dr["SubCategoryName"].ToString() + "&user=" + Session["UserName"] + "'>" + dr["SubCategoryName"].ToString() + "</a>";
                htmlStr += "</Li>";
            }
            //htmlStr += "</ul>";
            return htmlStr;
...

        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                htmlStr += "<option value = 'Product.aspx?txt=" + dr["SubCategoryName"].ToString() + "&user="+strUser +"'>" + dr["SubCategoryName"].ToString() + "</option>";
                //htmlStr += "<Li>";
        ...
        public string LoadTopLV2Image()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1  and FrontPosition=2 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1 and FrontPosition=2 and IsActive=1 and UserName='" + strUser + "'");
            };
            if (dt.Rows.Count > 0)
            {
                strTopLV2Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strTopLV2Category + "user="+strUser+"'>";
        ...
        public string LoadTopLV3Image()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1  and FrontPosition=3 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1 and FrontPosition=3 and IsActive=1 and UserName='" + strUser + "'");
            };
            if (dt.Rows.Count > 0)
            {
                strTopLV3Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strTopLV3Category + "&user="+strUser +"'>";
        ...
        public string LoadTopLV4Image()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1  and FrontPosition=4 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1 and FrontPosition=4 and IsActive=1 and UserName='" + strUser + "'");
            };
            if (dt.Rows.Count > 0)
            {
                strTopLV4Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strTopLV4Category + "&user="+strUser+"'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' style='margin-left:35px' height='190' width='150'>";
        ...
        public string LoadTopLV5Image()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1  and FrontPosition=1 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowLeftFront_5=1 and FrontPosition=1 and IsActive=1 and UserName='" + strUser + "'");
            };
            if (dt.Rows.Count > 0)
            {
                strTopLV5Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strTopLV5Category + "&user="+strUser+"'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' style='margin-left:35px'  height='190' width='150'>";
        ...
        public string LoadTopLV1Image()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                strHtml += "<a href = 'Product.aspx?txt=" + strTopLV1Category + "&user="+strUser+"'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' style='margin-left:35px'  height='190' width='150'>";
                strHtml += "</a>";
        ...
        public string LoadTop1()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontTop_3=1 and FrontPosition=1 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontTop_3=1 and FrontPosition=1 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strTop1Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href='Product.aspx?txt=" + strTop1Category + "&user="+strUser+"'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='225' width='190'>";
        ...
        public string LoadTop2()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontTop_3=1 and FrontPosition=2 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontTop_3=1 and FrontPosition=2 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                //strHtml += "<img src='ProductImage/oilll.jpg' alt =''  height='225' width='180'>";
        ...
        public string LoadTop3()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontTop_3=1 and FrontPosition=3 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontTop_3=1 and FrontPosition=3 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                //strHtml += "<img src='ProductImage/oilll.jpg' alt =''  height='225' width=180'>";
        ...
        public string LoadMiddle1()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontMid_3=1 and FrontPosition=1 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontMid_3=1 and FrontPosition=1 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='225' width='190'>";
        ...
        public string LoadMiddle2()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontMid_3=1 and FrontPosition=2 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontMid_3=1 and FrontPosition=2 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='225' width='190'>";
        ...
        public string LoadMiddle3()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontMid_3=1 and FrontPosition=3 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontMid_3=1 and FrontPosition=3 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='225' width='190'>";
        ...
        public string LoadBottom1()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontBottom_3=1 and FrontPosition=1 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontBottom_3=1 and FrontPosition=1 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='225' width='190'>";
        ...
        public string LoadBottom2()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontBottom_3=1 and FrontPosition=2 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontBottom_3=1 and FrontPosition=2 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='225' width='190'>";
        ...
        public string LoadBottom3()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontBottom_3=1 and FrontPosition=3 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontBottom_3=1 and FrontPosition=3 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt =''  height='225' width='190'>";
        ...
        public string LoadSlider1()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=1 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=1 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strSlider1Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strSlider1Category + "&user=" + strUser + "''>";
        ...
        public string LoadSlider2()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=2 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=2 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strSlider2Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strSlider2Category + "&user=" + strUser + "''>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
                strHtml += "</a>";
                //    strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
        ...
        public string LoadSlider3()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=3 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=3 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strSlider3Category = dt.Rows[0]["SubCategoryName"].ToString() + "";

                strHtml += "<a href = 'Product.aspx?txt=" + strSlider3Category + "&user=" + strUser + "'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
                strHtml += "</a>";
        ...
        public string LoadSlider4()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=4 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=4 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strSlider4Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strSlider4Category + "&user=" + strUser + "'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
                strHtml += "</a>";
                //strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
        ...
        public string LoadSlider5()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=5 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=5 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {

                strSlider5Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strSlider5Category + "&user=" + strUser + "''>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
                strHtml += "</a>";
                //strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
        ...
        public string LoadSlider6()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=6 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=6 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strSlider6Category = dt.Rows[0]["SubCategoryName"].ToString() + "";

                strHtml += "<a href = 'Product.aspx?txt=" + strSlider6Category + "&user=" + strUser + "''>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
                strHtml += "</a>";
                //   strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
        ...
        public string LoadSlider7()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=7 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=7 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strSlider7Category = dt.Rows[0]["SubCategoryName"].ToString() + "";

                strHtml += "<a href = 'Product.aspx?txt=" + strSlider7Category + "&user=" + strUser + "'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
                strHtml += "</a>";
                //strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
        ...
        public string LoadSlider8()
        {
            ...
            if (strUser == "a")
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=8 and IsActive=1");
            }
            else
            {
                dt = MDC.getDataTable("select TOP 1 * from ItemMaster where ShowFrontSlider_10=1 and FrontPosition=8 and IsActive=1 and UserName='" + strUser + "'");
            }
            if (dt.Rows.Count > 0)
            {
                strSlider8Category = dt.Rows[0]["SubCategoryName"].ToString() + "";
                strHtml += "<a href = 'Product.aspx?txt=" + strSlider8Category + "&user=" + strUser + "'>";
                strHtml += "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
                strHtml += "</a>";
                //strHtml = "<img src='ProductImage/" + dt.Rows[0]["ImageName"].ToString() + "' alt ='' width='190' height='225'>";
        ...
        public string MainMenu()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    strHtml += "<li>" +
                        "<a href = 'Product.aspx?txt=" + dr["SubCategoryName"].ToString() + "&user=" + strUser + "'>" + dr["SubCategoryName"].ToString() + "</a>";
                    strHtml += "</li>";
                    //strHtml += "<li>";
        ...
        {
            //DataTable dt = MDC.getDataTable("select * from UserMaster where Email='" + txtUserName.Value + "' and Password='" + txtPaasword.Value + "'");
            DataTable dt = MDC.getDataTable("select * from Individual_App1 where UserName='" + txtUserName.Value + "' and Password='" + txtPaasword.Value + "' and IsApproved=1");

            if (dt.Rows.Count > 0)
            {
                //if (dt.Rows[0]["TypeName"].ToString() == "Form_D_Individual" || dt.Rows[0]["TypeName"].ToString() == "Form_D_Society")
                    if (dt.Rows[0]["TypeName"].ToString() == "D-Individual" || dt.Rows[0]["TypeName"].ToString() == "D-Society")
                    {
                        Session["usertype"] = dt.Rows[0]["TypeName"].ToString();
                ...
                else
                {
                    ...
                    MessageBox.Show("No Dealer Found!");
                }
            }
            else
            {
