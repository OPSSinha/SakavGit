<%@ Page Language="C#"   AutoEventWireup="true" CodeBehind="MyOrderDetail.aspx.cs" Inherits="BachatBazaar.MyOrderDetail" %>
...
<form id="form1" runat="server">
    ...
    <%-- <div align="center" style="background-color:white;width:100%" >--%>
              ...
              <tr>
                  <td colspan="2">
                      <br />
                       <asp:GridView ID="gvMenuTiming"  runat="server" AutoGenerateColumns="False" CssClass="myTableClass" Width="800px" OnRowCommand="gvMenuTiming_RowCommand">
          ...
          --%>           <%--   <Columns>
                        ...
                        <Columns>
                           <asp:TemplateField HeaderText="Order Id" Visible ="false">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="txtOrderId" CommandName = "Show"  CommandArgument ='<%# Eval("FK_OrderId") %>' Width="40px" Text='<%# Eval("FK_OrderId") %>' runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>                          
                       
                            <asp:TemplateField HeaderText="Id" Visible ="false" >
                                        <ItemTemplate>
                                            <asp:Label ID="txtSno" Width="40px" Text='<%# Eval("Sno") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                          
                         <asp:TemplateField HeaderText="ImageId" Visible ="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblItemId" Width="40px" Text='<%# Eval("ItemId") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                              </asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Image">
                                        <ItemTemplate>
                                            <asp:ImageButton  ID="Img"  Width ="115px" Height ="165px" CommandName = "ShowMe" CommandArgument ='<%# Eval("FK_OrderId") %>' Text='<%# Eval("ItemId") %>' runat="server"></asp:ImageButton>
                                        </ItemTemplate>
                              </asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Item Name">
                                        <ItemTemplate>
                                            <asp:Label ID="txtItemName"  Width="120px" Text='<%# Eval("ItemName") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            <asp:TemplateField HeaderText="Qty">
                                        <ItemTemplate>
                                            <asp:Label ID="txtQty"  Width="40px" Text='<%# Eval("Qty") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="txtAmount"  Width="40px" Text='<%# Eval("Amount") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                 <%--   <asp:TemplateField HeaderText="Item Name">
                                        <ItemTemplate>
