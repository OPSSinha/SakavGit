<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryMaster.aspx.cs" Inherits="BachatBazaar.CategoryMaster" %>
...
<!--    <ul class="navbar-nav ml-auto">-->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="Default.aspx?user=<%=Session["UserName"].ToString() %>" class="brand-link">
        ...
        <div align="center">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox class="form-control" ID="txtCategoryName" Enabled ="false" runat ="server" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <asp:CheckBox ID="chkIsActive" runat ="server" Visible="false" />
                    </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <br />
                           <asp:Button ID="btnSubmit" class="form-control btn btn-primary" runat ="server" Text ="Submit" Visible="false" OnClick="lblUpload_Click" />
                        </td>
                    </tr>
              <tr>
                  <td colspan="2">
