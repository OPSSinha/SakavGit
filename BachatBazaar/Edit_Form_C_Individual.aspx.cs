...
{
    public partial class Edit_Form_C_Individual : System.Web.UI.Page
    {
        ...
        protected void GetDate()
        {
            ...
            if (Id > 0)
            {
                ...
                DataTable dt = MDC.getDataTable("select * from Individual_App1 where PK_APP_ID="+Id);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                       ...
                       // txtJilaEnglish.Text=dr["District"].ToString();
                        txtJilaHindi.Text = dr["District"].ToString();
                        ...
                        txtSurnameHindi.Text = dr["SurNameHindi1"].ToString();
                        txtSurnameEng.Text = dr["SurNameEng1"].ToString();
