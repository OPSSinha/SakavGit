...
<asp:Content ID ="contents4" ContentPlaceHolderID ="ContentPlaceHolder1" runat ="server">
    <!-- //Web-Fonts -->
                  ...
                  <tr>
                      <td  class="auto-style4"> 
                           Reg No. &nbsp;&nbsp;<asp:TextBox ID="txtRegNo" runat ="server" Enabled ="false" ></asp:TextBox>
                                    ...
                                    <td style="width:40%" >
                                        Ref. Member
                                        <asp:DropDownList ID="drpRefMember" style="border-color:black" runat="server" OnSelectedIndexChanged="drpRefMember_SelectedIndexChanged">
 ...
 <br />
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtBuildingHindiName" runat="server" style="border-color:black" class="form-control" width="190px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>मार्ग क्र. / नाम </td>
                        <td>
                            <asp:TextBox ID="txtMargEnglish" runat="server" style="border-color:black" AutoPostBack="true" class="form-control" OnTextChanged="txtMargEnglish_TextChanged" width="190px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="txtMargHindi" runat="server" style="border-color:black" class="form-control" width="190px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtLandMarkEnglish" runat="server" style="border-color:black" AutoPostBack="true" class="form-control" OnTextChanged="txtLandMarkEnglish_TextChanged" width="190px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="txtLandMarkHindi" runat="server" style="border-color:black" class="form-control" width="190px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>राज्य </td>
                        <td>
                            <asp:DropDownList ID="DrpState" runat="server"  style="width:200px;border-color:black" AutoPostBack="true" OnSelectedIndexChanged="DrpState_SelectedIndexChanged">
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td>शहर </td>
                        <td>
                            <asp:DropDownList ID="DrpCity"  style="width:200px;border-color:black" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DrpCity_SelectedIndexChanged">
                            </asp:DropDownList>
                            <asp:TextBox ID="txtCityEnglish" style="width:200px;border-color:black"  runat="server" AutoPostBack="true" class="form-control"  Visible="false"  width="190px"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>तहसील </td>
                        <td>
                            <asp:TextBox ID="txtBlockEnglish" runat="server" style="border-color:black" AutoPostBack="true" class="form-control" OnTextChanged="txtBlockEnglish_TextChanged" width="190px"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtJilaHindi" runat="server" style="border-color:black" class="form-control" Visible="false" width="190px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>पिन </td>
                        <td>
                           <asp:DropDownList ID="DrpPinCode" style="border-color:black" runat="server">
                                        </asp:DropDownList>
                        ...
                        <td colspan="3">
                            <table width="90%">
                                <tr>
                                    ...
                                    <td>फ़ोन एस टी डी </td>
                                    <td>
                                        <asp:TextBox ID="txtPhone" style="border-color:black" runat="server" class="form-control" width="190px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>ईमेल आय डी </td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtEmail" style="border-color:black" runat="server" class="form-control" width="190px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>PAN NO. </td>
          ...
          <td  style="margin-left:400px;">
                        ...
                        <asp:DropDownList ID="drpCategory" style="border-color:black" runat ="server"   Enabled ="true"  AutoPostBack="true"  >
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox class="form-control" ID="txtFirm" style="border-color:black"  width="319px" runat ="server" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox class="form-control" ID="TextAddress" style="border-color:black"   width="318px" runat ="server" ></asp:TextBox>
                    </td>
                </tr>
                 <tr>
                    <td colspan ="2">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan ="8" height="200px" valign="top"> 
                                    <asp:TextBox class="form-control" type="button" style="border-color:black"  ID="txtDetail" runat ="server" TextMode ="MultiLine" Width="100%" Height ="198px" ></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                <td> 
                                 ...
                                 <td> 
                                    <asp:TextBox  class="form-control" ID="txtAnnualSale" style="border-color:black" width="190" runat ="server" ></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                <td> 
                                 ...
                                 <td> 
                                    <asp:TextBox class="form-control" style="border-color:black" ID="txtWorkArea" width="190" runat ="server" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
