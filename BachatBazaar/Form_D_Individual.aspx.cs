...
namespace BachatBazaar
{
    public partial class Form_D_Individual : System.Web.UI.Page
    {
        ...
        {
            Int32 k = 0;
            DataTable dt = MDC.getDataTable("select * from Individual_App where   TypeName='Form_C_Individual' OR TypeName='Form_C_Society'");
