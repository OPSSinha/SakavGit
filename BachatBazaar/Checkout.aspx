    ...
    <script>
     ...
     <script>
          function getDateVal() {
              ...
              var hdVal = document.getElementById("hdVal");
          //    var txtDate = document.getElementById("txtSearchDate");
            //  hdVal.value = txtDate.value;
...
alert("Error: " + error);
    ...
    <script>
        ...
        //function clickMe() {
        //    alert("Clicekd");
        //         document.getElementById("btnSubmit_Click").click();
        //}
       function seeVal(id, jd)
       {
            var qtys = document.getElementById(id).value;
            var rates = document.getElementById(jd).value;
            grate = (document.getElementById(jd).value) / (document.getElementById(id).value);
            gqty = document.getElementById(id).value;

            var data = HTMLtbl.getData($('#tbldata'));

            //const tableMath = document.getElementById('tbldata');  
            var rc = 0;
            for (let line = 0; line < data.length-1; line++)
            {
                rc = rc + parseFloat(data[line][5]);
            }
            document.getElementById('txtTotal').value = rc;
        }
     function getChange(id,jd) {
          
            //}
            var qty = document.getElementById(id).value;
            var rate = document.getElementById(jd).value;
          
         if (parseFloat(grate) > 0) {
               // document.getElementById(jd).value = parseFloat(qty) * parseFloat(rate);
                document.getElementById(jd).value = parseFloat(qty) * parseFloat(grate);
            ...
            document.getElementById('txtTotal').value = Math.round(rc);
          //  i = i + 1;
          //  alert("changed-" + qty + " rate-" + rate);
        }
        function plusVal(qtId,rate)
        {
          
            TotRate = document.getElementById('txtTotal').value;
          //  alert("inner-" + qtId);
            var lval = document.getElementById(rate).value;
            var lQty = document.getElementById(qtId).value;
            var unitRate = parseFloat(lval) / parseFloat(lQty); 
            //
            lQty = parseFloat(lQty) + 1;
            document.getElementById(qtId).value = lQty;
        //   var lrate= document.getElementById(rate).value;
            var lrate=lval/gqty
           //   alert("Finaal-"+document.getElementById(gqty).value);
          
          //  alert("RateId-" + rate + "Qty-" + gqty + "-Amt-" + document.getElementById(rate).value);
          
            document.getElementById(rate).value = parseFloat(lQty) * parseFloat(unitRate);
...
<body>
            ...
            <div class="col-md-8 header">
                ...
                <div class="agileits_search">
                   <form action="#" method="post">
                       ...
                       <%=strEmailId %> &nbsp;&nbsp; <select id="drpSearch" style ="height:30px; width :260px;margin-top:20px" name="agileinfo_search" placeholder="How can we help you today?" required="" onchange="location = this.value;">
    ...
    <!-- signin Model -->
    <!-- Modal1 -->
    <div class="modal fade" id="myModal1"  style="opacity:90" tabindex="-1" role="dialog">
                    ...
                    <form id="frm" action="#" runat="server" class="creditly-card-form agileinfo_form">
                        ...
                        <div class="creditly-wrapper wthree, w3_agileits_wrapper">
                            <div class="information-wrapper">
                                <div class="first-row">
                                    ...
                                    <div class="w3_agileits_card_number_grids">
                                        <div class="w3_agileits_card_number_grid_left">
                                            <div class="controls">
                                                <input type="text" runat="server" id ="txtMobileNo" placeholder="Mobile Number" name="number" maxlength="10" required="">
                                            </div>
                                        </div>
                                ...
                                <label>
                                      Confirm Order
                                    <input type="checkbox"  ID="chkConfirm" name ="chkConfirm" onchange="GetCheck();" class="checkbox" value="0"  ;"/>
                                </label>
                                <br />
                            <%--    <button type="button"  id="btn_SubmitClick" class="btn btn-primary" onclick="clickMe();" runat="server"  style="width:950px;">Delivery to this Addres</button>--%>

                          <asp:Button id="btn_SubmitClick"  CssClass="btn btn-primary" runat="server" OnClientClick="GetCheck();"  OnClick="btnSubmit_Click"  Text ="Delivery to this Address"  />
                          <input id="sendServer" type="hidden" name="sendServer"  value="Confirm Order" />
                       &nbsp&nbsp  <asp:Label runat="server" Text="Your Offline Order-" ></asp:Label>
                    <a href="OfflineReceipt.aspx" >Generate a Offline Receipt </a>
                            </div>
                        </div>
    ...
    <div class="copy-right">
        <div class="container">
            <p>© 2021 Sakav. All rights reserved | Design by
                <a href="http://www.masutechnologies.com"> Masuautomation.</a>
            </p>
        </div>
    </div>
    <!-- //copyright -->
