...
namespace BachatBazaar
{
    ...
    public partial class Product : System.Web.UI.Page
    {
        ...
        public string GetTops()
        {
            ...
            DataTable dt = MDC.getDataTable("Select * from ItemMaster where UserName='"+strUser+"' and SubCategoryName='" + txt + "' and IsActive=1 and ShowTop3=1");
...
//                        if (k == 1 || k == 4 || k == 8 || k == 12 || k == 16 || k == 20 || k == 24 || k == 28 || k == 32 || k == 36 || k == 40 || k == 44 || k == 48 || k == 52)
        ...
        public string GetSlider()
        {
            ...
            //DataTable dt = MDC.getDataTable("select* from ItemMaster where ShowSlider9 = 1 and Position> 0 and SubCategoryName='" + txt + "' and IsActive=1");
            DataTable dt = MDC.getDataTable("select* from ItemMaster where UserName='" + strUsers + "' and ShowSlider9 = 1 and SubCategoryName='" + txt + "' and IsActive=1");
        ...
        public string GetLeft()
        {
            ...
            DataTable dt = MDC.getDataTable("Select * from ItemMaster where UserName='" + strUsers+"' and  SubCategoryName ='" + txt + "' and IsActive=1 and ShowLeft5=1");
